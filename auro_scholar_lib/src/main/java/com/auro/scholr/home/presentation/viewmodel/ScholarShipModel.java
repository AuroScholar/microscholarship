...
public class ScholarShipModel extends ViewModel {
    ...
    public ScholarShipModel(HomeUseCase homeUseCase, HomeDbUseCase homeDbUseCase, HomeRemoteUseCase homeRemoteUseCase) {
    }
