package com.auro.scholr.home.presentation.view.activity.newUi;
...
public class StudentNewDashBoardActivity extends BaseActivity implements OnItemClickListener, View.OnClickListener, BottomNavigationView.OnNavigationItemSelectedListener, CommonCallBackListner {
    ...
    protected int getLayout() {
        return R.layout.student_new_activity_dashboard;
    }
