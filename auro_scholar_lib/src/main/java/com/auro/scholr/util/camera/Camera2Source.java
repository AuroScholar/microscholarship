...
public class Camera2Source {
    ...
    /**
     * An {@link com.auro.scholr.util.camera.AutoFitTextureView} for camera preview.
     */
    private com.auro.scholr.util.camera.AutoFitTextureView mTextureView;
     ...
     * <p/>
     * This camera source may be restarted again by calling {@link #start(com.auro.scholr.util.camera.AutoFitTextureView, int)}.
     * <p/>
    ...
    public Camera2Source start(@NonNull com.auro.scholr.util.camera.AutoFitTextureView textureView, int displayOrientation) throws IOException {
