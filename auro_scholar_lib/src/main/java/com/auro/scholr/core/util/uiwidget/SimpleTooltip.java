...
public class SimpleTooltip implements PopupWindow.OnDismissListener {
    ...
    private static final int mDefaultMarginRes = R.dimen._10sdp;
    private static final int mDefaultPaddingRes = R.dimen._8sdp;
    private static final int mDefaultAnimationPaddingRes = R.dimen._4sdp;
    private static final int mDefaultAnimationDurationRes = R.integer.simpletooltip_animation_duration;
    private static final int mDefaultArrowWidthRes = R.dimen._30sdp;
    private static final int mDefaultArrowHeightRes = R.dimen._15sdp;
    private static final int mDefaultOverlayOffsetRes = R.dimen._10sdp;
    ...
    public static class Builder {
        ...
        public Builder textSize(int textColor) {
