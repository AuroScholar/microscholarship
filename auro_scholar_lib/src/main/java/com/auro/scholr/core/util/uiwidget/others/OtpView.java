...
import com.auro.scholr.core.util.uiwidget.AsteriskPasswordTransformationMethod;
...
public class OtpView extends LinearLayout {
  ...
  private void styleEditTexts(TypedArray styles) {
    ...
    if (length > 0) {
      ...
      int hintColor = styles.getColor(R.styleable.OtpView_hint_color, AuroApp.getAppContext().getColor(R.color.color_light_grey));
